    ...
    <div className="fixed inset-0 backdrop-blur-sm bg-black/30 flex items-center justify-center z-50">
      <div className="bg-white/90 backdrop-blur-md rounded-xl p-8 max-w-md w-full mx-4 relative shadow-xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to continue tracking your calories</p>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <nav className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <h1 className="text-2xl font-bold text-blue-600">CalorieTrack</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Simple, effective, and personalized calorie tracking to help you maintain a healthy lifestyle and reach your fitness goals.
          </p>
          <button 
            onClick={() => setIsLoginModalOpen(true)}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-blue-50 p-6 rounded-xl">
              ...
              <p className="text-gray-600">Quick and simple food logging with an extensive database of items.</p>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-xl">
              ...
              <p className="text-gray-600">Track your progress with detailed nutritional insights and charts.</p>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-xl">
              ...
              <p className="text-gray-600">Set and achieve your personal health and fitness goals.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-600 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">Join thousands of users who have already transformed their lives.</p>
          <button 
            onClick={() => setIsLoginModalOpen(true)}
            className="bg-white text-blue-600 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-gray-100 transform hover:scale-105 transition-all"
          >
            Get Started Now
          </button>
        </div>
      ...
      <footer className="bg-gray-50 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-gray-600">
            <p>&copy; 2024 CalorieTrack. All rights reserved.</p>
          </div>
        </div>
      </footer>
